...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://ibb.co/VBm9G9d Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'OLIGRACE;Skl11;0;https://ibb.co/VBm9G9d;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    ...
    BOT_NAME: process.env.BOT_NAME || 'OLIGRACE',
